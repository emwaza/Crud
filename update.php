    ...
    if ( !empty($_POST)) {
       ...
       if (empty($Application_Criteria)) {
        ...
        if ($valid) {
            ...
            $sql = "UPDATE Vacancies set Category = ?, Duration = ?, Position = ?, Responsibilities = ? , Qualifications = ? , Salary = ?, Application_Criteria = ?";
            $q = $pdo->prepare($sql);
        ...
        $Salary = $data['Salary'];
        $Application_Criteria =$data['Application_Criteria'];
        Database::disconnect();
    }
?>
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="create.php" method="post">
                      ...
                      <div class="control-group <?php echo !empty($QualificationsError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="Qualifications" type="text"  placeholder="Qualification " value="<?php echo !empty($Qualifications )?$Qualifications :'';?>">
                      ...
                      <div class="control-group <?php echo !empty($SalaryError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="Salary" type="number" placeholder="Position " value="<?php echo !empty($Salary)?$Salary  :'';?>">
